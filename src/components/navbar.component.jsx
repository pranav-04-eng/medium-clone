  ...
  return (
    ...
    <nav className="navbar">
      ...
      <div className="flex items-center gap-3 md:gap-6 ml-auto">
        <button className="md:hidden bg-grey w-12 h-12 rounded-full flen items-center justify-center ">
          <i
        ...
        <Link to="/editor" className="hidden md:flex gap-2 link">
          <i className="fi fi-sr-file-edit text-2xl block mt-1"></i>
          <p>Write</p>
        </Link>
